// eero_cradle.scad  -- v3
// v3: front screws pulled inboard for straight driver access, bigger windows,
//     1.2mm chamfer on the outer bottom edge, vertical sizing derived from measurements.
...
/* ---------- wall windows ---------- */
win_border = 8;   // solid frame left around each window (smaller = bigger windows)
...
module chamfer_envelope() {
    bz = lip0 - lip_t;                       // model bottom (pre-shear)
